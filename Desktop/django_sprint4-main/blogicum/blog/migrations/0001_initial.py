# Generated by Django 6.0 on 2025-12-21 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(help_text='Если выбрать дату и время в будущем, то публикация будет отложенной.', verbose_name='Дата и время публикации')),
